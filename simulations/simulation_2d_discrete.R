...
#VU = (tau+1)/2
#beta_true = c(beta0(VU),beta1(VU),beta2(VU))
...
unique_rows <- unique(x)
  ...
  #Res_mrock = rq(ES_int[,3]~ES_int[,1:2],0.9)$coefficients - beta_true
...
write.table(d,file=paste("/home/shushuz/M_rock/results_2d_type6/n",n,"p",p,"tau",tau,"seed",seed,".csv",sep=""),sep=",",
                row.names=FALSE)
